  ...
  it("Uniswap token should have all information populated", () => {
    ...
    cy.get('[data-cy="resources-container"]').within(() => {
      cy.contains("Etherscan")
        ...
        .and(
          "include",
          "etherscan.io/address/0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984"
        );
      cy.contains("More analytics")
        .should("have.attr", "href")
        .and(
          "include",
          "info.uniswap.org/#/tokens/0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984"
        );
      cy.contains("Website")
        .should("have.attr", "href")
  ...
  it("token with warning and low trading volume should have all information populated", () => {
    ...
    cy.get('[data-cy="resources-container"]').within(() => {
      cy.contains("Etherscan")
        ...
        .and(
          "include",
          "etherscan.io/address/0xa71d0588EAf47f12B13cF8eC750430d21DF04974"
        );
      cy.contains("More analytics")
        .should("have.attr", "href")
        .and(
          "include",
          "info.uniswap.org/#/tokens/0xa71d0588EAf47f12B13cF8eC750430d21DF04974"
        );
      cy.contains("Website").should("have.attr", "href").and("include", "qom");
      cy.contains("Twitter")
        .should("have.attr", "href")
        .and("include", "twitter.com/ShibaPredator1");
    });
