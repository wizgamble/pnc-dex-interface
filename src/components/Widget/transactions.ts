  ...
  const onTxSubmit = useCallback(
    (_hash: string, transaction: Transaction<TransactionInfo>) => {
      ...
      if (!type || !response) {
        ...
        type === WidgetTransactionType.WRAP ||
        type === WidgetTransactionType.UNWRAP
      ) {
        ...
        const eventProperties = {
          ...
          token_out_address: getTokenAddress(
            transactionAmount.currency.wrapped
          ),
          ...
          amount: transactionAmount
            ? formatToDecimal(
                transactionAmount,
                transactionAmount?.currency.decimals
              )
            : undefined,
          type:
            type === WidgetTransactionType.WRAP
