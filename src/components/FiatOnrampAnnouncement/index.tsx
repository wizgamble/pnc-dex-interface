...
const Wrapper = styled.button`
  background: radial-gradient(
      105% 250% at 100% 5%,
      hsla(318, 95%, 85%) 1%,
      hsla(331, 80%, 75%, 0.1) 84%
    ),
    linear-gradient(
      180deg,
      hsla(296, 92%, 67%, 0.5) 0%,
      hsla(313, 96%, 60%, 0.5) 130%
    );
...
export function FiatOnrampAnnouncement() {
  ...
  return (
    <ArrowWrapper>
      ...
      <CloseIcon
        onClick={handleClose}
        data-testid="FiatOnrampAnnouncement-close"
      />
      <Wrapper onClick={handleClick}>
        ...
        <Body>
          <Trans>
            Get tokens at the best prices in web3 on Uniswap, powered by
            Moonpay.
          </Trans>
        </Body>
      </Wrapper>
