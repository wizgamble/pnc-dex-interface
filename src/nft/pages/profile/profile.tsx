...
const LoadedAccountPage = styled.div<{
  ...
  margin: 0px
    ${({ isOnV2ListPage }) => (isOnV2ListPage ? LIST_PAGE_MARGIN : 0)}px;

  @media screen and (max-width: ${BREAKPOINTS.lg}px) {
    width: calc(
      100% -
        ${({ isOnV2ListPage }) =>
          isOnV2ListPage ? LIST_PAGE_MARGIN_TABLET * 2 : 0}px
    );
    margin: 0px
      ${({ isOnV2ListPage }) =>
        isOnV2ListPage ? LIST_PAGE_MARGIN_TABLET : 0}px;
  }
  ...
  @media screen and (max-width: ${BREAKPOINTS.sm}px) {
    width: calc(
      100% -
        ${({ isOnV2ListPage }) =>
          isOnV2ListPage ? LIST_PAGE_MARGIN_MOBILE * 2 : 0}px
    );
    margin: 0px
      ${({ isOnV2ListPage }) =>
        isOnV2ListPage ? LIST_PAGE_MARGIN_MOBILE : 0}px;
  }
`;
...
const ProfileContent = () => {
  ...
  const removeAllMarketplaceWarnings = useSellAsset(
    (state) => state.removeAllMarketplaceWarnings
  );
