...
const PercentChange = styled.div<{ isNegative: boolean }>`
  color: ${({ theme, isNegative }) =>
    isNegative ? theme.accentFailure : theme.accentSuccess};
  display: flex;
  align-items: center;
...
const StatsRow = ({
  ...
  const arrow = stats?.stats?.one_day_floor_change
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        src={
          stats.isFoundation && !stats.imageUrl
            ? "/nft/svgs/marketplaces/foundation.svg"
            : stats.imageUrl
        }
      />
      <Box className={styles.statsText}>
